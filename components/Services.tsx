...
const services = [
  { id: '01', title: 'Strategy', jp: '戦略策定', image: 'https://images.unsplash.com/photo-1486406146926-c627a92ad1ab?q=80&w=2070&auto=format&fit=crop' },
  { id: '02', title: 'Art Direction', jp: '視覚演出', image: 'https://images.unsplash.com/photo-1561070791-2526d30994b5?q=80&w=2000&auto=format&fit=crop' },
  { id: '03', title: 'Development', jp: '高度実装', image: 'https://images.unsplash.com/photo-1550751827-4bd374c3f58b?q=80&w=2070&auto=format&fit=crop' },
  { id: '04', title: 'Experience', jp: '体験設計', image: 'https://images.unsplash.com/photo-1550684848-fac1c5b4e853?q=80&w=2070&auto=format&fit=crop' },
  { id: '05', title: 'Growth', jp: '事業成長', image: 'https://images.unsplash.com/photo-1551288049-bebda4e38f71?q=80&w=2070&auto=format&fit=crop' }
];
        ...
        <div className="flex flex-col">
          {services.map((service, index) => (
            <motion.div
              ...
              className="group relative border-b border-white/10 py-12 md:py-16 cursor-hover transition-colors hover:bg-white/5 z-10"
            >
              <div className="flex items-baseline justify-between pointer-events-none">
                <div className="flex items-baseline gap-8 md:gap-16">
                    ...
                    <h3 className="font-sans text-3xl md:text-6xl font-light tracking-tight text-gray-300 group-hover:text-white group-hover:pl-4 transition-all duration-500 ease-out">
                        {service.title}
                    </h3>
                </div>
                <span className="font-serif text-sm md:text-xl text-gray-600 group-hover:text-white transition-colors hidden md:block">
                    {service.jp}
                </span>
              </div>
            </motion.div>
