      ...
      <AnimatePresence>
        {isOpen && (
          ...
          >
            ...
            <nav className="flex flex-col items-center gap-6 md:gap-8">
              {navItems.map((item, i) => (
                <div key={item.label} className="overflow-hidden">
                    ...
                    className="block font-serif text-5xl md:text-7xl lg:text-8xl text-transparent text-stroke hover:text-white transition-colors duration-500 cursor-hover tracking-tight"
            ...
            <div className="absolute bottom-8 left-0 w-full text-center text-xs font-mono text-gray-500 uppercase tracking-widest">
              Tokyo, Japan
            </div>
          </motion.div>
        )}
